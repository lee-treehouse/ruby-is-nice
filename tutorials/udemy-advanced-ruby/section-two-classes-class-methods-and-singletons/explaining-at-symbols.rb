...
# ok so we talked about class methods ie static methods 
# we can also have static properties ie 'class variable'
# these have @@ double a
# I had been wondering what the single @ was 
# it is for an instance property 'instance variable) 
